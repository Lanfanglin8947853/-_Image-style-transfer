...
class NeuralStyleTransferModel(tf.keras.Model):
    ...
    def __init__(self, content_layers: typing.Dict[str, float] = settings.CONTENT_LAYERS,# settings.CONTENT_LAYERS内容特征层及loss加权系数
                 style_layers: typing.Dict[str, float] = settings.STYLE_LAYERS):         # settings.STYLE_LAYERS风格特征层及loss加权系数
